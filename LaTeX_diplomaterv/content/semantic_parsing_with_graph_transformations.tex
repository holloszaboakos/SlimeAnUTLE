...
Az UD projekt egy nyelvek közötti konzisztens annotációs rendszer és fa-adatbázis hatvannál is több nyelvre. Kategóriák és annotációk univerzális készletét nyújtja, miközben megenged nyelvfüggő kiterjesztéseket is. Az UD a Stanford Dependencies-ből \cite{deMarneffe:2008} fejlődött ki, és lehetővé teszi nyelvfüggetlen dependenciaparszerek kiértékelését.
...
\begin{table}[h]
    ...
    \begin{tabular}{lc}
        ...
        \bottomrule                         
    \end{tabular}
    \caption{UD függőségek leképezése 4lang részgráfokra \cite[p. 12.]{Recski:2018}}
    \label{table:deps}
    \end{table}
...
A fát merge nélkül praktikusan csak három bemenetű szabállyal lehetséges implementálni, lásd példa~\ref{sec:example2}.
...
Az első generátort én készítettem el 2018 augusztusában. 
...
Jelenleg egy másik programmal generálunk IRTG-t, amely stringmanipulációk helyett strukturált adatból generálja a szabályokat, ez még fejlesztés alatt áll.

A Slime első verziója nem lesz képes gráfműveletekre, de könnyű lesz benne olyan kódot készíteni, ami mindenki számára érthető, mindezt minimális overhead-del, így csak a bemeneti adatokat szükséges generálni hozzá. 
