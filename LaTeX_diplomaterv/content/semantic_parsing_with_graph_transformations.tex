...
\centering
\graphicspath{./}
\includegraphics[scale=0.32]{TeXstudio.png}
\todo{ITT LESZ MAJD A FA, HA KÉPKÉNT ILLESZTED BE; A SCALE-NÉL ÁLLÍTGATHATOD A MÉRETET} 
...
\label{sec:irtg}
%----------------------------------------------------------------------------
Az IRTG (Interpreted Regular Tree Grammar, interpretált reguláris fa-nyelvtan) \todo{hivatkozás!!!!} egy kontextusfüggetlen nyelvtan, ami egy vagy több algebrába beágyazott újraíró szabályokból áll.
