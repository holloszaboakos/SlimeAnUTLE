...
\caption{~\ref{sec:example1} levezetési fája}
\label{fig:example1}
\end{figure}
...
\caption{~\ref{sec:example2} levezetési fája}
\label{fig:example2}
\end{figure}
...
\caption{~\ref{sec:example3} levezetési fája}
\label{fig:example3}
\end{figure}
...
\caption{~\ref{sec:example4} levezetési fája}
\label{fig:example4}
\end{figure}
...
\caption{~\ref{sec:example5} levezetési fája}
...
\caption{~\ref{sec:example5} kimenetének műveleti fája}
...
\caption{~\ref{sec:example5} kimenetének végeredménye}
...
\caption{~\ref{sec:example6} levezetési fája}
\label{fig:example6}
\end{figure}
...
\caption{~\ref{sec:example6} kimenetének műveleti fája}
