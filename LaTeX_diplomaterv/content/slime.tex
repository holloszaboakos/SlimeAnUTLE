...
A Smarty-hoz hasonlóan (\todo{Lásd fejezet ...}) a parancsokat az alárendelt kódba ágyazzuk.
...
A Mustache-hoz hasonlóan (\todo{Lásd fejezet ...}) a blokkok típusát a blokkon belül jelöli egy-két karakterrel.
...
A több parancsot tartalmazó zárójelekben(\todo{Lásd fejezet ...}) a parancsokat pontosvesszűvel választjuk el.
...
Egy változóhoz nevek később is adhatóak a Name típus segítségével (\todo{lásd fejezet... }).
...
Például, ha egy listát készítünk, és vesszővel felsoroljuk az elemeit (\todo{Lásd fejezet ...}).
...
A legtöbb nyelvben a sablonoknak két féle komponense van, a szöveg és a mező. (\todo{lásd fejezet mustache})
...
Ha a Temp egy mezőjébe szúrnak valamit, akkor az megszűnik. \todo{clean fase}
\item \emph{Spec:} 
...
A TEMP-ek tömörségéről pedig a haladó szintaxis gondolkodik.( \todo{lásd fejezet ...})
...
Itt azért nem a kacsacsőr zárójeleket használjuk, mert azokkal már a kompakt zárójelezést jelöljük. (\todo{Lásd fejezet ...})
