...
OB_EXPA : '{<' 	        -> pushMode(B_OPER);
OB_INSE : '{>' 	        -> pushMode(B_OPER);
...
OB_EXPA_B_O : '{<' 	    -> pushMode(B_OPER);
OB_INSE_B_O : '{>' 	    -> pushMode(B_OPER);
...
OB_EXPA_O_O : '{<' 	    -> pushMode(B_OPER);
OB_INSE_O_O : '{>' 	    -> pushMode(B_OPER);
...
OB_EXPA_L_O : '{<' 	    -> pushMode(B_OPER);
OB_INSE_L_O : '{>' 	    -> pushMode(B_OPER);
